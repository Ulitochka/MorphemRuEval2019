...
class LossComputeBase(nn.Module):
    ...
    def _make_shard_state(self, batch, output, range_, attns=None):
        ...
        Args:
            ...
            output: the predict output from the models.
            range_: the range of examples for computing, the whole
                    batch or a trunc of it?
            attns: the attns dictionary returned from the models.
        """
    ...
    def __call__(self,
        ...
        Args:
          ...
          output (:obj:`FloatTensor`) :
              output of decoder models `[tgt_len x batch x hidden]`
...
class LabelSmoothingLoss(nn.Module):
    ...
    and p_{prob. computed by models}(w) is minimized.
    """
...
def shards(state, shard_size, eval_only=False):
    ...
    Args:
        ...
        shard_size: The maximum size of the shards yielded by the models.
