...
def model_opts(parser):
    """
    These options are passed to the construction of the models.
    ...
    group.add('--model_type', '-model_type', default='text',
              ...
              help="""Type of source models to use. Allows
...
def train_opts(parser):
    ...
    group.add('--save_model', '-save_model', default='models',
              help="""Model filename (the models will be saved as
    ...
    group.add('--train_from', '-train_from', default='', type=str,
              help="""If training from a checkpoint then this is the
                       path to the pretrained models's state_dict.""")
...
def translate_opts(parser):
    ...
    group.add('--models', '-models', dest='models', metavar='MODEL',
              nargs='+', type=str, default=[], required=True,
              help='Path to models .pt file(s). '
