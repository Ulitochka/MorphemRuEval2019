...
def build_base_model(model_opt, fields, gpu, checkpoint=None):
    ...
    Args:
        ...
        fields: `Field` objects for the models.
        gpu(bool): whether to use gpu.
        checkpoint: the models gnerated by train phase, or a resumed snapshot
                    models from a stopped training.
    Returns:
        the NMTModel.
    """
    assert model_opt.model_type in ["text", "img", "audio"], \
        "Unsupported models type %s" % model_opt.model_type
    ...
    # Load the models states from checkpoint or initialize them.
