...
### Actions are typically models training / translation
### or options setter.
###
...
###     
###     - Train and translate a specific models (e.g. lstm):
###             ./test_models.sh lstm translate
###             note that translate only consider the last models therefore:
###             ./test_models.sh lstm cnn translate
###             would actually use CNN models for translation
###  
